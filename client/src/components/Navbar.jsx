                ...
                <div className="flex items-center gap-6 text-sm font-medium">
                    {!isAuthenticated ? (
                        <>
                            ...
                            <Link to="/hsp" className="text-brand-cream/70 hover:text-brand-mint transition-colors">
                                For HSPs
                            </Link>
                            <Link to="/developers" className="text-brand-cream/70 hover:text-brand-mint transition-colors">
                                For Developers
                            </Link>
                            <Link
                                to="/login"
