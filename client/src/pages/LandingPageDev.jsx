...
const response = await fetch('https://api.uhiapp.com/v1/appointments', {
  method: 'POST',
  headers: {
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
                            Build on <span className="text-gradient">UHI</span>
                        </h1>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-[hsl(220_20%_60%)] text-lg mb-10">
                            Create your developer account and get instant access to the UHI API sandbox.
                        </p>
                        <Link
                            to="/signup"
